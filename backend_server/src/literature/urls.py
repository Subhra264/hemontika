...
from .views import StoryListView, PoemListView, NovelListView, BookViewSet, StoryDetailsView, PoemDetailsView, NovelDetailsView
...
urlpatterns = [
    ...
    path("catagories/stories/<int:pk>/details/", StoryDetailsView.as_view(), name="literature.catagories.stories.story"),
