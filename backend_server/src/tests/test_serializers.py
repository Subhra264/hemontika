...
class TestSerializers(TestCase):
    ...
    def test_story_serializer(self):
        ...
        data = {"id":1,"title":"a story about serializer","front_img":None,"date":self.DATE,"content":"hello all","author":1,"tags":[1,2,3]}
        ...
        data = [{"id":1,"title":"a story about serializer","front_img":None,"date":self.DATE,"content":"hello all","author":1,"tags":[1,2,3]},
                {"id":2,"title":"title","front_img":None,"date":self.DATE,"content":"sharlock homes","author":1,"tags":[1]},
                {"id":3,"title":"A man with a twisted lip","front_img":None,"date":self.DATE,"content":"bla bla bla","author":2,"tags":[]},
        ]
        data = json.dumps(data)
        self.assertJSONEqual(json_data, data)
    ...
    def test_poem_serializer(self):
        ...
        poem2 = Poem.objects.create(author=john,title='two blossoms', content='hello blossoms')
        poem3 = Poem.objects.create(author=john,title='three blossoms',content='happy blossoms')
        serializer1 = PoemSerializer(poem)
        data = {"id":1,"title":"blossoms","front_img":None,"date":self.DATE,"content":" beautiful blossoms","author":1,"tags":[1]}
        data = json.dumps(data)
        json_data = JSONRenderer().render(serializer1.data)
        self.assertJSONEqual(json_data, data)
        serializer2 = PoemSerializer(Poem.objects.all(),many=True)
        data = [{"id":1,"title":"blossoms","front_img":None,"date":self.DATE,"content":" beautiful blossoms","author":1,"tags":[1]},
                {"id":2,"title":"two blossoms","front_img":None,"date":self.DATE,"content":"hello blossoms","author":2,"tags":[]},
                {"id":3,"title":"three blossoms","front_img":None,"date":self.DATE,"content":"happy blossoms","author":2,"tags":[]}
        ]
        data = json.dumps(data)
        json_data = JSONRenderer().render(serializer2.data)
        self.assertJSONEqual(json_data, data)
    ...
    def test_novel_serializer(self):
        ...
        data = {"id":1,"title":"A novel NOT about testing","front_img":None,"date":self.DATE,"number_of_chapters":2,"author":1,"tags":[1,]}
        data = json.dumps(data)
        ...
        data = [{"id":1,"title":"A novel NOT about testing","front_img":None,"date":self.DATE,"number_of_chapters":2,"author":1,"tags":[1,]},
                {"id":2,"title":"Another novel","front_img":None,"date":self.DATE,"number_of_chapters":3,"author":2,"tags":[]}
            ]
        data = json.dumps(data)
        json_data = JSONRenderer().render(serializer2.data)
        self.assertJSONEqual(json_data, data)
    ...
    def test_chapter_serializer(self):
        ...
        json_data = JSONRenderer().render(serializer2.data)
        data = [{"id":1,"title":"A novel about testing Part- 1","front_img":None,"date":self.DATE,"content":"hello chapter","author":1,"previous_chapter":None,"novel":1,"tags":[]},
                {"id":2,"title":"A novel about testing Part- 2","front_img":None,"date":self.DATE,"content":"chapter 2","author":1,"previous_chapter":1,"novel":1,"tags":[]}
        ]
        data = json.dumps(data)
        self.assertJSONEqual(json_data, data)
    ...
    def test_book_serializer(self):
        ...
        data = {"id":1,"title":" a book about testing","front_img":None,"date":self.DATE,"number_of_contents":4,"author":1,"tags":[],"novels":[1],"stories":[1],"poems":[1,2]}
        data = json.dumps(data)
        self.assertJSONEqual(json_data,data)